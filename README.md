...
- **Six adapters, with different limits.** Claude Code is the reference;
  ...
  matching rules. GitHub Copilot CLI is mapped from session prompt turns and
  suggested shell executions. ATIF is a standard rather than a runtime, and
  Cline's SDK format is a published contract; neither carries file content
