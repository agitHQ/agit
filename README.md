...
- **Six adapters, with different limits.** Claude Code is the reference;
  ...
  matching rules. Cursor agent transcripts are mapped from prompt turns, tool
  calls, and token usage. ATIF is a standard rather than a runtime, and Cline's SDK
